...
public class Snakeview extends Application {
    ...
    private void drawApple() {
        ...
        Image applePng = new Image("resources\\apple.png");
    ...
    private void drawPoisonApple() {
        ...
        Image poisonApplePng = new Image("resources\\poisonApple.png");
        ImageView image = new ImageView();
    ...
    private void drawBomb() {
        ...
        Image bombPng = new Image("resources\\bomb.png");
        ImageView image = new ImageView();
    ...
    private void drawCoconut() {
        ...
        Image coconutPng = new Image("resources\\coconut.png");
        ImageView image = new ImageView();
    ...
    private void drawStar() {
        ...
        Image starPng = new Image("resources\\star.png");
        ImageView image = new ImageView();
    ...
    private void drawMushroom() {
        ...
        Image mushroomPng = new Image("resources\\brownMushroom.png");
        ImageView image = new ImageView();
    ...
    private void drawSnake() {
        for (Point point : model.getSnake()) {
            ...
            if (point.equals(model.getSnake().get(0))) {
                Image snakeHead = new Image("resources/snakeSprite/" + model.getBodyDirections().get(0) + "-head.png");
                ...
                Image snakeTail = new Image("resources/snakeSprite/"
                ...
                Image snakeBody = new Image(
                        "resources/snakeSprite/" + model.getBodyDirections().get(model.getSnake().indexOf(point))
