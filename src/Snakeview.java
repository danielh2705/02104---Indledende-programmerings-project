...
public class Snakeview extends Application {
    ...
    private void drawApple() {
        ...
        Image applePng = new Image(getClass().getResource("/apple.png").toExternalForm());
    ...
    private void drawPoisonApple() {
        ...
        Image poisonApplePng = new Image(getClass().getResource("/poisonApple.png").toExternalForm());
        ImageView image = new ImageView();
    ...
    private void drawBomb() {
        ...
        Image bombPng = new Image(getClass().getResource("/bomb.png").toExternalForm());
        ImageView image = new ImageView();
    ...
    private void drawCoconut() {
        ...
        Image coconutPng = new Image(getClass().getResource("/coconut.png").toExternalForm());
        ImageView image = new ImageView();
    ...
    private void drawStar() {
        ...
        Image starPng = new Image(getClass().getResource("/star.png").toExternalForm());
        ImageView image = new ImageView();
    ...
    private void drawMushroom() {
        ...
        Image mushroomPng = new Image(getClass().getResource("/brownMushroom.png").toExternalForm());
        ImageView image = new ImageView();
    ...
    private void drawSnake() {
        for (Point point : model.getSnake()) {
            ...
            if (point.equals(model.getSnake().get(0))) {
                Image snakeHead = new Image(getClass().getResource("/snakeSprite/" + model.getBodyDirections().get(0) + "-head.png").toExternalForm());
                ...
                Image snakeTail = new Image(getClass().getResource("/snakeSprite/"
                        + model.getBodyDirections().get(model.getBodyDirections().size() - 2) + "-tail.png").toExternalForm());
                ...
                Image snakeBody = new Image(
                        getClass().getResource("/snakeSprite/" + model.getBodyDirections().get(model.getSnake().indexOf(point))
                                + model.getBodyDirections().get(model.getSnake().indexOf(point) - 1) + "-body.png").toExternalForm());
